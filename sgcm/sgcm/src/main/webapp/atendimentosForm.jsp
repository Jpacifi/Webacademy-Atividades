...
<jsp:useBean id="item" class="br.ufac.sgcm.model.Atendimento" scope="page"/>
    ...
    <body>
        ...
        <main>
            <form method="post">
                ...
                value="<%=Objects.toString(item.getData(), "")%>">
                <label>Status</label>
                <input type="text" name="status" id="status"
                value="<%=Objects.toString(item.getStatus(), "")%>">
                <label>Convênio ID</label>
                <input type="text" name="convenio_id" id="convenio_id"
                value="<%=Objects.toString(item.getConvenio_id(), "")%>">
                <label>Paciente ID</label>
                <input type="text" name="paciente_id" id="paciente_id"
                value="<%=Objects.toString(item.getPaciente_id(), "")%>">
                <label>Profissional ID</label>
                <input type="text" name="profissional_id" id="profissional_id"
                value="<%=Objects.toString(item.getProfissional_id(), "")%>">
                </div>

                <input type="button" value="Cancelar" data-url="atendimentos.jsp">
